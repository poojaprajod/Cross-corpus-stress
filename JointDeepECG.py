...
for s in parts:
    ...
    if not trained:
        ...
        callbacks = [  # EarlyStopping(monitor='val_acc', patience=10, min_delta=0.0001, mode='max'),
            ModelCheckpoint(filepath=f'best_model_ecg_val_{s}_znorm_deepecg_joint.h5',
        ...
        with open("model_ecg_deepecg_joint.json", "w") as json_file:
            json_file.write(model_json)

    model_full.load_weights(f'best_model_ecg_val_{s}_znorm_deepecg_joint.h5')
